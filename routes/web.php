...
Route::get('/dashboard', [DashboardController::class, 'index'])->middleware(['auth', 'verified'])->name('admin');
...
/*---------------------------Inventory--------------------------------------*/
Route::get('/inventory', [ProductController::class, 'index2'])->name('inventory');
