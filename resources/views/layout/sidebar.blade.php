<div class="pb-3 sidebar pe-4">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="index.html" class="mx-4 mb-3 navbar-brand">
                    <h3 class="text-success"><i class="fa fa-user-edit me-2"></i>PMS POS</h3>
                </a>
                <div class="mb-4 d-flex align-items-center ms-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src={{"public/uploads/01685752087.jpg"}} alt="" style="width: 40px; height: 40px;">
                        <div class="bottom-0 p-1 border border-2 border-white bg-success rounded-circle position-absolute end-0"></div>
                    </div>
                    <div class="ms-3">
                        <h6 class="mb-0 text-success">Shuvo</h6>
                        <span>Admin</span>
                    </div>
                </div>
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Manufacturer</a>
                        <div class="bg-transparent border-0 dropdown-menu">
                            <a href="{{ route('brand') }}" class="dropdown-item">Add Manufacturer</a>
                            <a href="viewbrands" class="dropdown-item">All Manufacturer</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown">
